...
export class Atomo {
     ...
     */
    get valore(): number | boolean | string { return this._valore; }

    /**
     * Restituisce il tipo semantico dell'atomo.
     */
    get tipo(): TipoAtomo { return this._tipo; }
    ...
    static fromString(s: string): Atomo {
        ...
        if (sTrimmed === '#t' || sTrimmed === '#true' || sTrimmed === 'true' || sTrimmed === 'vero' || sTrimmed === '#vero') {
            return new Atomo(true, TipoAtomo.BOOLEANO);
        }
        if (sTrimmed === '#f' || sTrimmed === '#false' || sTrimmed === 'false' || sTrimmed === 'falso' || sTrimmed === '#falso') {
